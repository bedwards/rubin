...
LOFI_VOCAL = VocalPreset(
    ...
    comp_ratio=4.0,           # Lo-fi squash but musical — 6:1 was too crushed
    comp_attack_ms=5.0,
...
LOFI_GUITAR = GuitarPreset(
    ...
    comp_ratio=4.0,           # Matched to vocal to avoid guitar sounding overly squashed
    comp_attack_ms=8.0,
