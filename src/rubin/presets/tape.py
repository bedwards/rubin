...
TAPE_VOCAL = VocalPreset(
    ...
    saturation_mix=0.6,
    comp_threshold_db=-10.0,    # Tape compressor on loud peaks
    comp_ratio=3.5,
    comp_attack_ms=4.0,
    ...
    comp2_ratio=2.0,
    comp2_attack_ms=35.0,
    comp2_release_ms=180.0,
    comp2_makeup_db=1.0,
...
TAPE_GUITAR = GuitarPreset(
    ...
    saturation_mix=0.65,
    comp_threshold_db=-12.0,   # Works with raw 0dBFS guitar peaks
    comp_ratio=3.0,
    comp_attack_ms=12.0,
...
TAPE_MASTER = MasterPreset(
    ...
    glue_comp_threshold_db=-9.0,
    glue_comp_ratio=1.5,
    glue_comp_attack_ms=45.0,
    glue_comp_release_ms=350.0,
    glue_comp_makeup_db=1.0,
